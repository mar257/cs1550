...
_sampledriver:     file format elf32-i386
...
printf(1, "init_graphics: %d", init_graphics());
  11:	e8 9c 03 00 00       	call   3b2 <init_graphics>
  16:	83 ec 04             	sub    $0x4,%esp
  19:	50                   	push   %eax
  1a:	68 b0 07 00 00       	push   $0x7b0
  1f:	6a 01                	push   $0x1
  21:	e8 6a 04 00 00       	call   490 <printf>
printf(1, "exit_graphics: %d", exit_graphics());
  26:	e8 8f 03 00 00       	call   3ba <exit_graphics>
  2b:	83 c4 0c             	add    $0xc,%esp
  2e:	50                   	push   %eax
  2f:	68 c2 07 00 00       	push   $0x7c2
  34:	6a 01                	push   $0x1
  36:	e8 55 04 00 00       	call   490 <printf>
printf(1, "getkey: %d", getkey());
  3b:	e8 82 03 00 00       	call   3c2 <getkey>
  40:	83 c4 0c             	add    $0xc,%esp
  43:	50                   	push   %eax
  44:	68 d4 07 00 00       	push   $0x7d4
  49:	6a 01                	push   $0x1
  4b:	e8 40 04 00 00       	call   490 <printf>
printf(1, "clear_screen %d", clear_screen());
  50:	e8 75 03 00 00       	call   3ca <clear_screen>
  55:	83 c4 0c             	add    $0xc,%esp
  58:	50                   	push   %eax
  59:	68 df 07 00 00       	push   $0x7df
  5e:	6a 01                	push   $0x1
...
printf(1, "draw_pixel: %d", draw_pixel(1,2,3));
  ...
  6a:	6a 02                	push   $0x2
  6c:	6a 01                	push   $0x1
  6e:	e8 5f 03 00 00       	call   3d2 <draw_pixel>
  73:	83 c4 0c             	add    $0xc,%esp
  76:	50                   	push   %eax
  77:	68 ef 07 00 00       	push   $0x7ef
  7c:	6a 01                	push   $0x1
  7e:	e8 0d 04 00 00       	call   490 <printf>
printf(1, "draw_line: %d", draw_line(1,2,3,4,5));
  83:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  8a:	6a 04                	push   $0x4
  8c:	6a 03                	push   $0x3
  8e:	6a 02                	push   $0x2
  90:	6a 01                	push   $0x1
  92:	e8 43 03 00 00       	call   3da <draw_line>
  97:	83 c4 1c             	add    $0x1c,%esp
  9a:	50                   	push   %eax
  9b:	68 fe 07 00 00       	push   $0x7fe
  a0:	6a 01                	push   $0x1
  a2:	e8 e9 03 00 00       	call   490 <printf>
printf(1, "blit: %d", blit());
  a7:	e8 36 03 00 00       	call   3e2 <blit>
  ac:	83 c4 0c             	add    $0xc,%esp
  af:	50                   	push   %eax
  b0:	68 0c 08 00 00       	push   $0x80c
  b5:	6a 01                	push   $0x1
...
putc(int fd, char c)
{
 ...
 5a8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5ab:	b8 15 08 00 00       	mov    $0x815,%eax
...
free(void *ap)
{
 ...
 6aa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ad:	a3 b4 0a 00 00       	mov    %eax,0xab4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 76f:	89 15 b4 0a 00 00    	mov    %edx,0xab4
      return (void*)(p + 1);
 ...
 784:	eb e9                	jmp    76f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 b4 0a 00 00 b8 	movl   $0xab8,0xab4
 78d:	0a 00 00 
 790:	c7 05 b8 0a 00 00 b8 	movl   $0xab8,0xab8
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 b8 0a 00 00       	mov    $0xab8,%eax
 79f:	c7 05 bc 0a 00 00 00 	movl   $0x0,0xabc
 7a6:	00 00 00 
