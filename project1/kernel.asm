...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 b3 7b 10 80 	movl   $0x80107bb3,(%esp)
...
80101ea8:	68 9a 79 10 80       	push   $0x8010799a
...
801022f2:	81 fb 48 65 11 80    	cmp    $0x80116548,%ebx
...
{
  if(!lapic)
801025f0:	a1 1c 37 11 80       	mov    0x8011371c,%eax
...
{
  if (!lapic)
801026f0:	a1 1c 37 11 80       	mov    0x8011371c,%eax
  lapicw(TPR, 0);
}
...
{
  lapic[index] = value;
8010277e:	a1 1c 37 11 80       	mov    0x8011371c,%eax
...
801029b0:	8b 0d 68 37 11 80    	mov    0x80113768,%ecx
...
80102a34:	39 1d 68 37 11 80    	cmp    %ebx,0x80113768
...
80102a57:	ff 35 54 37 11 80    	pushl  0x80113754
80102a5d:	ff 35 64 37 11 80    	pushl  0x80113764
80102a63:	e8 68 d6 ff ff       	call   801000d0 <bread>
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
80102a68:	8b 0d 68 37 11 80    	mov    0x80113768,%ecx
...
80102a88:	8b 8a 6c 37 11 80    	mov    -0x7feec894(%edx),%ecx
...
80102abf:	68 20 37 11 80       	push   $0x80113720
...
80102adb:	59                   	pop    %ecx
  ...
  log.size = sb.nlog;
  log.dev = dev;
80102adc:	89 1d 64 37 11 80    	mov    %ebx,0x80113764
  ...
  log.start = sb.logstart;
  log.size = sb.nlog;
80102ae2:	89 15 58 37 11 80    	mov    %edx,0x80113758
    panic("initlog: too big logheader");
  ...
  readsb(dev, &sb);
  log.start = sb.logstart;
80102ae8:	a3 54 37 11 80       	mov    %eax,0x80113754
...
read_head(void)
{
  ...
  int i;
  log.lh.n = lh->n;
80102afd:	89 0d 68 37 11 80    	mov    %ecx,0x80113768
  for (i = 0; i < log.lh.n; i++) {
...
80102b17:	89 8a 68 37 11 80    	mov    %ecx,-0x7feec898(%edx)
{
  struct buf *buf = bread(log.dev, log.start);
  struct logheader *lh = (struct logheader *) (buf->data);
  int i;
...
80102b2a:	e8 81 fe ff ff       	call   801029b0 <install_trans>
  log.lh.n = 0;
80102b2f:	c7 05 68 37 11 80 00 	movl   $0x0,0x80113768
80102b36:	00 00 00 
...
80102b53:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102b56:	68 20 37 11 80       	push   $0x80113720
...
80102b6b:	68 20 37 11 80       	push   $0x80113720
80102b70:	68 20 37 11 80       	push   $0x80113720
...
begin_op(void)
{
  ...
  while(1){
    if(log.committing){
80102b7d:	a1 60 37 11 80       	mov    0x80113760,%eax
80102b82:	85 c0                	test   %eax,%eax
80102b84:	75 e2                	jne    80102b68 <begin_op+0x18>
      sleep(&log, &log.lock);
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102b86:	a1 5c 37 11 80       	mov    0x8011375c,%eax
80102b8b:	8b 15 68 37 11 80    	mov    0x80113768,%edx
...
80102b9f:	83 ec 0c             	sub    $0xc,%esp
      ...
      log.outstanding += 1;
80102ba2:	a3 5c 37 11 80       	mov    %eax,0x8011375c
      release(&log.lock);
80102ba7:	68 20 37 11 80       	push   $0x80113720
...
80102bc6:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102bc9:	68 20 37 11 80       	push   $0x80113720
80102bce:	e8 cd 16 00 00       	call   801042a0 <acquire>
  log.outstanding -= 1;
80102bd3:	a1 5c 37 11 80       	mov    0x8011375c,%eax
  if(log.committing)
80102bd8:	8b 1d 60 37 11 80    	mov    0x80113760,%ebx
...
end_op(void)
{
  ...
  acquire(&log.lock);
  log.outstanding -= 1;
80102be6:	a3 5c 37 11 80       	mov    %eax,0x8011375c
  if(log.committing)
...
80102bf9:	83 ec 0c             	sub    $0xc,%esp
  ...
  if(log.outstanding == 0){
    do_commit = 1;
    log.committing = 1;
80102bfc:	c7 05 60 37 11 80 01 	movl   $0x1,0x80113760
80102c03:	00 00 00 
}
...
80102c06:	31 db                	xor    %ebx,%ebx
  ...
  release(&log.lock);
80102c08:	68 20 37 11 80       	push   $0x80113720
...
{
  if (log.lh.n > 0) {
80102c12:	8b 0d 68 37 11 80    	mov    0x80113768,%ecx
...
80102c28:	a1 54 37 11 80       	mov    0x80113754,%eax
80102c2d:	83 ec 08             	sub    $0x8,%esp
80102c30:	01 d8                	add    %ebx,%eax
80102c32:	83 c0 01             	add    $0x1,%eax
80102c35:	50                   	push   %eax
80102c36:	ff 35 64 37 11 80    	pushl  0x80113764
80102c3c:	e8 8f d4 ff ff       	call   801000d0 <bread>
80102c41:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102c43:	58                   	pop    %eax
80102c44:	5a                   	pop    %edx
80102c45:	ff 34 9d 6c 37 11 80 	pushl  -0x7feec894(,%ebx,4)
80102c4c:	ff 35 64 37 11 80    	pushl  0x80113764
static void
write_log(void)
{
  int tail;
...
80102c8c:	3b 1d 68 37 11 80    	cmp    0x80113768,%ebx
...
80102c99:	e8 12 fd ff ff       	call   801029b0 <install_trans>
    log.lh.n = 0;
80102c9e:	c7 05 68 37 11 80 00 	movl   $0x0,0x80113768
80102ca5:	00 00 00 
...
80102cb0:	68 20 37 11 80       	push   $0x80113720
80102cb5:	e8 e6 15 00 00       	call   801042a0 <acquire>
    log.committing = 0;
    wakeup(&log);
80102cba:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
  if(do_commit){
    // call commit w/o holding locks, since not allowed
    // to sleep with locks.
    commit();
    acquire(&log.lock);
    log.committing = 0;
80102cc1:	c7 05 60 37 11 80 00 	movl   $0x0,0x80113760
80102cc8:	00 00 00 
    wakeup(&log);
80102ccb:	e8 10 12 00 00       	call   80103ee0 <wakeup>
    release(&log.lock);
80102cd0:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
...
80102cf3:	68 20 37 11 80       	push   $0x80113720
80102cf8:	e8 e3 11 00 00       	call   80103ee0 <wakeup>
  }
  release(&log.lock);
80102cfd:	c7 04 24 20 37 11 80 	movl   $0x80113720,(%esp)
...
80102d37:	8b 15 68 37 11 80    	mov    0x80113768,%edx
//   modify bp->data[]
//   log_write(bp)
//   brelse(bp)
void
...
80102d69:	68 20 37 11 80       	push   $0x80113720
80102d6e:	e8 2d 15 00 00       	call   801042a0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102d73:	8b 15 68 37 11 80    	mov    0x80113768,%edx
...
80102d84:	31 c0                	xor    %eax,%eax
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102d86:	3b 0d 6c 37 11 80    	cmp    0x8011376c,%ecx
80102d8c:	75 0b                	jne    80102d99 <log_write+0x69>
80102d8e:	eb 38                	jmp    80102dc8 <log_write+0x98>
80102d90:	39 0c 85 6c 37 11 80 	cmp    %ecx,-0x7feec894(,%eax,4)
...
80102da0:	89 0c 95 6c 37 11 80 	mov    %ecx,-0x7feec894(,%edx,4)
  if (i == log.lh.n)
    log.lh.n++;
80102da7:	83 c2 01             	add    $0x1,%edx
80102daa:	89 15 68 37 11 80    	mov    %edx,0x80113768
  b->flags |= B_DIRTY; // prevent eviction
80102db0:	83 0b 04             	orl    $0x4,(%ebx)
  release(&log.lock);
80102db3:	c7 45 08 20 37 11 80 	movl   $0x80113720,0x8(%ebp)
}
...
80102dc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  log.lh.block[i] = b->blockno;
80102dc8:	89 0c 85 6c 37 11 80 	mov    %ecx,-0x7feec894(,%eax,4)
80102dcf:	eb df                	jmp    80102db0 <log_write+0x80>
80102dd1:	8b 43 08             	mov    0x8(%ebx),%eax
80102dd4:	a3 6c 37 11 80       	mov    %eax,0x8011376c
  if (i == log.lh.n)
...
80102e6f:	bb 20 38 11 80       	mov    $0x80113820,%ebx
// Allocate a real stack and switch to it, first
// doing some setup required for memory allocator to work.
int
main(void)
...
80102e7c:	68 48 65 11 80       	push   $0x80116548
...
80102ecf:	68 09 b5 10 80       	push   $0x8010b509
80102ed4:	68 00 70 00 80       	push   $0x80007000
80102ed9:	e8 e2 15 00 00       	call   801044c0 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
80102ede:	69 05 a0 3d 11 80 b0 	imul   $0xb0,0x80113da0,%eax
80102ee5:	00 00 00 
80102ee8:	83 c4 10             	add    $0x10,%esp
80102eeb:	05 20 38 11 80       	add    $0x80113820,%eax
...
80102f48:	74 f6                	je     80102f40 <main+0xe0>
  ...
  for(c = cpus; c < cpus+ncpu; c++){
80102f4a:	69 05 a0 3d 11 80 b0 	imul   $0xb0,0x80113da0,%eax
80102f51:	00 00 00 
80102f54:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80102f5a:	05 20 38 11 80       	add    $0x80113820,%eax
...
801030cf:	a3 1c 37 11 80       	mov    %eax,0x8011371c
...
80103145:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
    ...
    case MPPROC:
      ...
      if(ncpu < NCPU) {
80103148:	8b 0d a0 3d 11 80    	mov    0x80113da0,%ecx
...
80103160:	89 0d a0 3d 11 80    	mov    %ecx,0x80113da0
  for(p=(uchar*)(conf+1), e=(uchar*)conf+conf->length; p<e; ){
    switch(*p){
    case MPPROC:
      proc = (struct mpproc*)p;
      if(ncpu < NCPU) {
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
80103166:	88 97 20 38 11 80    	mov    %dl,-0x7feec7e0(%edi)
        ncpu++;
      }
...
8010317c:	83 c0 08             	add    $0x8,%eax
    ...
    case MPIOAPIC:
      ioapic = (struct mpioapic*)p;
      ioapicid = ioapic->apicno;
8010317f:	88 15 00 38 11 80    	mov    %dl,0x80113800
      p += sizeof(struct mpioapic);
      continue;
...
801035b4:	bb f4 3d 11 80       	mov    $0x80113df4,%ebx
// If found, change state to EMBRYO and initialize
// state required to run in the kernel.
// Otherwise return 0.
static struct proc*
...
801035b9:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&ptable.lock);
801035bc:	68 c0 3d 11 80       	push   $0x80113dc0
...
801035d3:	81 fb f4 5c 11 80    	cmp    $0x80115cf4,%ebx
...
801035ea:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  ...
  release(&ptable.lock);
801035f1:	68 c0 3d 11 80       	push   $0x80113dc0
  release(&ptable.lock);
  return 0;
...
80103653:	68 c0 3d 11 80       	push   $0x80113dc0
...
80103673:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103676:	68 c0 3d 11 80       	push   $0x80113dc0
...
801036cb:	68 c0 3d 11 80       	push   $0x80113dc0
...
801036ec:	e8 ff ef ff ff       	call   801026f0 <lapicid>
  ...
  for (i = 0; i < ncpu; ++i) {
801036f1:	8b 35 a0 3d 11 80    	mov    0x80113da0,%esi
801036f7:	85 f6                	test   %esi,%esi
801036f9:	7e 3f                	jle    8010373a <mycpu+0x5a>
    if (cpus[i].apicid == apicid)
801036fb:	0f b6 15 20 38 11 80 	movzbl 0x80113820,%edx
80103702:	39 d0                	cmp    %edx,%eax
80103704:	74 30                	je     80103736 <mycpu+0x56>
80103706:	b9 d0 38 11 80       	mov    $0x801138d0,%ecx
...
8010372d:	5b                   	pop    %ebx
  ...
  for (i = 0; i < ncpu; ++i) {
    if (cpus[i].apicid == apicid)
      return &cpus[i];
8010372e:	05 20 38 11 80       	add    $0x80113820,%eax
  }
  panic("unknown apicid\n");
}
80103733:	5e                   	pop    %esi
...
8010376b:	2d 20 38 11 80       	sub    $0x80113820,%eax
}
80103770:	c9                   	leave  
}
...
801037bc:	89 c3                	mov    %eax,%ebx
  ...
  initproc = p;
801037be:	a3 38 b6 10 80       	mov    %eax,0x8010b638
...
801037db:	68 dd b4 10 80       	push   $0x8010b4dd
...
80103866:	89 43 68             	mov    %eax,0x68(%ebx)
  ...
  acquire(&ptable.lock);
80103869:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80103875:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  ...
  release(&ptable.lock);
8010387c:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
801039d6:	8b 5f 10             	mov    0x10(%edi),%ebx
  ...
  acquire(&ptable.lock);
801039d9:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
801039e5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  ...
  release(&ptable.lock);
801039ec:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80103a61:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a64:	bb f4 3d 11 80       	mov    $0x80113df4,%ebx
  for(;;){
    // Enable interrupts on this processor.
    sti();
    ...
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80103a69:	68 c0 3d 11 80       	push   $0x80113dc0
...
80103a83:	81 fb f4 5c 11 80    	cmp    $0x80115cf4,%ebx
...
80103aba:	83 c4 10             	add    $0x10,%esp
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103abd:	81 fb f4 5c 11 80    	cmp    $0x80115cf4,%ebx
      swtch(&(c->scheduler), p->context);
      switchkvm();
...
80103ad3:	68 c0 3d 11 80       	push   $0x80113dc0
...
80103b0d:	68 c0 3d 11 80       	push   $0x80113dc0
...
80103bc9:	e8 82 07 00 00       	call   80104350 <popcli>
{
  ...
  if(curproc == initproc)
80103bce:	39 35 38 b6 10 80    	cmp    %esi,0x8010b638
...
80103c14:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  ...
  acquire(&ptable.lock);
80103c1b:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80103c57:	3d f4 5c 11 80       	cmp    $0x80115cf4,%eax
80103c5c:	75 e4                	jne    80103c42 <exit+0x92>
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
80103c5e:	8b 0d 38 b6 10 80    	mov    0x8010b638,%ecx
80103c64:	ba f4 3d 11 80       	mov    $0x80113df4,%edx
...
80103c73:	81 fa f4 5c 11 80    	cmp    $0x80115cf4,%edx
...
80103c89:	b8 f4 3d 11 80       	mov    $0x80113df4,%eax
...
80103c93:	3d f4 5c 11 80       	cmp    $0x80115cf4,%eax
...
80103ce7:	68 c0 3d 11 80       	push   $0x80113dc0
...
80103d0d:	e8 de fd ff ff       	call   80103af0 <sched>
  release(&ptable.lock);
80103d12:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80103d60:	81 fe c0 3d 11 80    	cmp    $0x80113dc0,%esi
80103d66:	74 50                	je     80103db8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103d68:	83 ec 0c             	sub    $0xc,%esp
80103d6b:	68 c0 3d 11 80       	push   $0x80113dc0
...
80103d8c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
80103d93:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80103e0d:	68 c0 3d 11 80       	push   $0x80113dc0
...
80103e41:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e46:	81 fb f4 5c 11 80    	cmp    $0x80115cf4,%ebx
...
80103e5e:	68 c0 3d 11 80       	push   $0x80113dc0
...
80103ea5:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103eac:	c7 04 24 c0 3d 11 80 	movl   $0x80113dc0,(%esp)
...
80103ec7:	68 c0 3d 11 80       	push   $0x80113dc0
...
80103ee7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103eea:	68 c0 3d 11 80       	push   $0x80113dc0
...
80103f1f:	3d f4 5c 11 80       	cmp    $0x80115cf4,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f26:	c7 45 08 c0 3d 11 80 	movl   $0x80113dc0,0x8(%ebp)
}
...
80103f7f:	68 c0 3d 11 80       	push   $0x80113dc0
...
80103fd9:	bb 60 3e 11 80       	mov    $0x80113e60,%ebx
...
80103feb:	68 b3 7b 10 80       	push   $0x80107bb3
...
80103ff8:	83 c3 7c             	add    $0x7c,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ffb:	81 fb 60 5d 11 80    	cmp    $0x80115d60,%ebx
...
8010400e:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80104011:	ba 20 78 10 80       	mov    $0x80107820,%edx
  uint pc[10];
...
80104018:	8b 14 85 80 78 10 80 	mov    -0x7fef8780(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
8010401f:	b8 20 78 10 80       	mov    $0x80107820,%eax
...
8010402e:	68 24 78 10 80       	push   $0x80107824
...
8010406d:	68 61 72 10 80       	push   $0x80107261
...
8010409a:	68 98 78 10 80       	push   $0x80107898
...
80104343:	68 a3 78 10 80       	push   $0x801078a3
...
801043a5:	68 c2 78 10 80       	push   $0x801078c2
...
801043b2:	68 ab 78 10 80       	push   $0x801078ab
...
801043d1:	68 c9 78 10 80       	push   $0x801078c9
...
80104825:	83 fa 1b             	cmp    $0x1b,%edx
80104828:	77 1e                	ja     80104848 <syscall+0x38>
8010482a:	8b 14 85 00 79 10 80 	mov    -0x7fef8700(,%eax,4),%edx
...
80104850:	68 d1 78 10 80       	push   $0x801078d1
...
801049b4:	68 90 79 10 80       	push   $0x80107990
...
801049cc:	68 8f 79 10 80       	push   $0x8010798f
...
801049e1:	68 83 79 10 80       	push   $0x80107983
...
801049ee:	68 92 79 10 80       	push   $0x80107992
...
801049fb:	68 74 79 10 80       	push   $0x80107974
...
80104e0d:	58                   	pop    %eax
80104e0e:	5a                   	pop    %edx
80104e0f:	68 90 79 10 80       	push   $0x80107990
...
80104f7d:	68 b4 79 10 80       	push   $0x801079b4
...
80104f8a:	68 c6 79 10 80       	push   $0x801079c6
...
80104f97:	68 a2 79 10 80       	push   $0x801079a2
...
80105550:	68 00 5d 11 80       	push   $0x80115d00
...
8010555d:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105560:	8b 1d 40 65 11 80    	mov    0x80116540,%ebx
  while(ticks - ticks0 < n){
...
80105573:	68 00 5d 11 80       	push   $0x80115d00
80105578:	68 40 65 11 80       	push   $0x80116540
8010557d:	e8 ae e7 ff ff       	call   80103d30 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105582:	a1 40 65 11 80       	mov    0x80116540,%eax
...
801055a0:	68 00 5d 11 80       	push   $0x80115d00
...
801055c3:	68 00 5d 11 80       	push   $0x80115d00
...
801055e4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801055e7:	68 00 5d 11 80       	push   $0x80115d00
801055ec:	e8 af ec ff ff       	call   801042a0 <acquire>
  xticks = ticks;
801055f1:	8b 1d 40 65 11 80    	mov    0x80116540,%ebx
  release(&tickslock);
801055f7:	c7 04 24 00 5d 11 80 	movl   $0x80115d00,(%esp)
...
80105644:	c6 04 c5 44 5d 11 80 	movb   $0x0,-0x7feea2bc(,%eax,8)
8010564b:	00 
8010564c:	66 89 0c c5 42 5d 11 	mov    %cx,-0x7feea2be(,%eax,8)
80105653:	80 
80105654:	c6 04 c5 45 5d 11 80 	movb   $0x8e,-0x7feea2bb(,%eax,8)
8010565b:	8e 
8010565c:	66 89 14 c5 40 5d 11 	mov    %dx,-0x7feea2c0(,%eax,8)
80105663:	80 
80105664:	c1 ea 10             	shr    $0x10,%edx
80105667:	66 89 14 c5 46 5d 11 	mov    %dx,-0x7feea2ba(,%eax,8)
8010566e:	80 
void
tvinit(void)
{
...
80105689:	68 d5 79 10 80       	push   $0x801079d5
8010568e:	68 00 5d 11 80       	push   $0x80115d00
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105693:	66 89 15 42 5f 11 80 	mov    %dx,0x80115f42
8010569a:	c6 05 44 5f 11 80 00 	movb   $0x0,0x80115f44
801056a1:	66 a3 40 5f 11 80    	mov    %ax,0x80115f40
801056a7:	c1 e8 10             	shr    $0x10,%eax
801056aa:	c6 05 45 5f 11 80 ef 	movb   $0xef,0x80115f45
801056b1:	66 a3 46 5f 11 80    	mov    %ax,0x80115f46
...
801056db:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801056df:	b8 40 5d 11 80       	mov    $0x80115d40,%eax
...
80105720:	ff 24 85 7c 7a 10 80 	jmp    *-0x7fef8584(,%eax,4)
...
80105785:	68 38 7a 10 80       	push   $0x80107a38
...
8010586f:	68 e0 79 10 80       	push   $0x801079e0
...
801058e3:	68 00 5d 11 80       	push   $0x80115d00
801058e8:	e8 b3 e9 ff ff       	call   801042a0 <acquire>
      ticks++;
      wakeup(&ticks);
801058ed:	c7 04 24 40 65 11 80 	movl   $0x80116540,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
801058f4:	83 05 40 65 11 80 01 	addl   $0x1,0x80116540
      wakeup(&ticks);
801058fb:	e8 e0 e5 ff ff       	call   80103ee0 <wakeup>
      release(&tickslock);
80105900:	c7 04 24 00 5d 11 80 	movl   $0x80115d00,(%esp)
...
80105928:	68 04 7a 10 80       	push   $0x80107a04
8010592d:	e8 2e ad ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105932:	83 c4 14             	add    $0x14,%esp
80105935:	68 da 79 10 80       	push   $0x801079da
...
{
  if(!uart)
80105940:	a1 3c b6 10 80       	mov    0x8010b63c,%eax
  outb(COM1+0, c);
}
...
80105a17:	74 5a                	je     80105a73 <uartinit+0xb3>
    return;
  uart = 1;
80105a19:	c7 05 3c b6 10 80 01 	movl   $0x1,0x8010b63c
80105a20:	00 00 00 
...
80105a2f:	bb fc 7a 10 80       	mov    $0x80107afc,%ebx
...
uartputc(int c)
{
  ...
  if(!uart)
80105a5a:	8b 15 3c b6 10 80    	mov    0x8010b63c,%edx
...
uartputc(int c)
{
  ...
  if(!uart)
80105a80:	8b 15 3c b6 10 80    	mov    0x8010b63c,%edx
    uartputc(*p);
}
...
8010663d:	68 04 7b 10 80       	push   $0x80107b04
...
801066e2:	68 86 74 10 80       	push   $0x80107486
...
80106708:	66 89 90 98 38 11 80 	mov    %dx,-0x7feec768(%eax)
8010670f:	66 89 88 9a 38 11 80 	mov    %cx,-0x7feec766(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106716:	ba ff ff ff ff       	mov    $0xffffffff,%edx
8010671b:	31 c9                	xor    %ecx,%ecx
8010671d:	66 89 90 a0 38 11 80 	mov    %dx,-0x7feec760(%eax)
...
80106724:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106729:	66 89 88 a2 38 11 80 	mov    %cx,-0x7feec75e(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106730:	31 c9                	xor    %ecx,%ecx
80106732:	66 89 90 a8 38 11 80 	mov    %dx,-0x7feec758(%eax)
80106739:	66 89 88 aa 38 11 80 	mov    %cx,-0x7feec756(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106740:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106745:	31 c9                	xor    %ecx,%ecx
80106747:	66 89 90 b0 38 11 80 	mov    %dx,-0x7feec750(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010674e:	c6 80 9c 38 11 80 00 	movb   $0x0,-0x7feec764(%eax)
static inline void
...
8010675a:	c6 80 9d 38 11 80 9a 	movb   $0x9a,-0x7feec763(%eax)
80106761:	c6 80 9e 38 11 80 cf 	movb   $0xcf,-0x7feec762(%eax)
80106768:	c6 80 9f 38 11 80 00 	movb   $0x0,-0x7feec761(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010676f:	c6 80 a4 38 11 80 00 	movb   $0x0,-0x7feec75c(%eax)
80106776:	c6 80 a5 38 11 80 92 	movb   $0x92,-0x7feec75b(%eax)
8010677d:	c6 80 a6 38 11 80 cf 	movb   $0xcf,-0x7feec75a(%eax)
80106784:	c6 80 a7 38 11 80 00 	movb   $0x0,-0x7feec759(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010678b:	c6 80 ac 38 11 80 00 	movb   $0x0,-0x7feec754(%eax)
80106792:	c6 80 ad 38 11 80 fa 	movb   $0xfa,-0x7feec753(%eax)
80106799:	c6 80 ae 38 11 80 cf 	movb   $0xcf,-0x7feec752(%eax)
801067a0:	c6 80 af 38 11 80 00 	movb   $0x0,-0x7feec751(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801067a7:	66 89 88 b2 38 11 80 	mov    %cx,-0x7feec74e(%eax)
801067ae:	c6 80 b4 38 11 80 00 	movb   $0x0,-0x7feec74c(%eax)
801067b5:	c6 80 b5 38 11 80 f2 	movb   $0xf2,-0x7feec74b(%eax)
801067bc:	c6 80 b6 38 11 80 cf 	movb   $0xcf,-0x7feec74a(%eax)
801067c3:	c6 80 b7 38 11 80 00 	movb   $0x0,-0x7feec749(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
801067ca:	05 90 38 11 80       	add    $0x80113890,%eax
...
801067f0:	a1 44 65 11 80       	mov    0x80116544,%eax
...
801068f4:	68 0a 7b 10 80       	push   $0x80107b0a
...
80106901:	68 35 7b 10 80       	push   $0x80107b35
...
8010690e:	68 20 7b 10 80       	push   $0x80107b20
...
80106989:	68 49 7b 10 80       	push   $0x80107b49
...
80106a3d:	68 63 7b 10 80       	push   $0x80107b63
...
80106a4a:	68 04 7c 10 80       	push   $0x80107c04
...
80106ae1:	68 81 7b 10 80       	push   $0x80107b81
...
80106b13:	68 99 7b 10 80       	push   $0x80107b99
...
80106bfc:	68 b5 7b 10 80       	push   $0x80107bb5
...
80106c9b:	a3 44 65 11 80       	mov    %eax,0x80116544
...
80106ccf:	68 c6 7b 10 80       	push   $0x80107bc6
...
80106db2:	68 ea 7b 10 80       	push   $0x80107bea
...
80106dbf:	68 d0 7b 10 80       	push   $0x80107bd0
...
80106ea0:	5d                   	pop    %ebp
80106ea1:	c3                   	ret    
80106ea2:	66 90                	xchg   %ax,%ax
80106ea4:	66 90                	xchg   %ax,%ax
80106ea6:	66 90                	xchg   %ax,%ax
80106ea8:	66 90                	xchg   %ax,%ax
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106eb1:	ba c2 03 00 00       	mov    $0x3c2,%edx
80106eb6:	89 e5                	mov    %esp,%ebp
80106eb8:	57                   	push   %edi
80106eb9:	56                   	push   %esi
80106eba:	53                   	push   %ebx
80106ebb:	8b 5d 08             	mov    0x8(%ebp),%ebx
80106ebe:	0f b6 03             	movzbl (%ebx),%eax
...
80106ec2:	31 c9                	xor    %ecx,%ecx
80106ec4:	bf c4 03 00 00       	mov    $0x3c4,%edi
80106ec9:	be c5 03 00 00       	mov    $0x3c5,%esi
80106ece:	89 c8                	mov    %ecx,%eax
80106ed0:	89 fa                	mov    %edi,%edx
80106ed2:	ee                   	out    %al,(%dx)
80106ed3:	0f b6 44 0b 01       	movzbl 0x1(%ebx,%ecx,1),%eax
80106ed8:	89 f2                	mov    %esi,%edx
80106eda:	ee                   	out    %al,(%dx)
80106edb:	83 c1 01             	add    $0x1,%ecx
80106ede:	83 f9 05             	cmp    $0x5,%ecx
80106ee1:	75 eb                	jne    80106ece <write_regs+0x1e>
80106ee3:	be d4 03 00 00       	mov    $0x3d4,%esi
80106ee8:	b8 03 00 00 00       	mov    $0x3,%eax
80106eed:	89 f2                	mov    %esi,%edx
80106eef:	ee                   	out    %al,(%dx)
static inline uchar
inb(ushort port)
{
  uchar data;
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106ef0:	b9 d5 03 00 00       	mov    $0x3d5,%ecx
80106ef5:	89 ca                	mov    %ecx,%edx
80106ef7:	ec                   	in     (%dx),%al
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106ef8:	83 c8 80             	or     $0xffffff80,%eax
80106efb:	ee                   	out    %al,(%dx)
80106efc:	b8 11 00 00 00       	mov    $0x11,%eax
80106f01:	89 f2                	mov    %esi,%edx
80106f03:	ee                   	out    %al,(%dx)
static inline uchar
inb(ushort port)
{
  uchar data;
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106f04:	89 ca                	mov    %ecx,%edx
80106f06:	ec                   	in     (%dx),%al
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106f07:	83 e0 7f             	and    $0x7f,%eax
...
/* make sure they remain unlocked */
	regs[0x03] |= 0x80;
80106f0b:	80 4b 09 80          	orb    $0x80,0x9(%ebx)
	regs[0x11] &= ~0x80;
80106f0f:	80 63 17 7f          	andb   $0x7f,0x17(%ebx)
/* write CRTC regs */
	for(i = 0; i < VGA_NUM_CRTC_REGS; i++)
80106f13:	31 c9                	xor    %ecx,%ecx
80106f15:	bf d4 03 00 00       	mov    $0x3d4,%edi
80106f1a:	be d5 03 00 00       	mov    $0x3d5,%esi
80106f1f:	90                   	nop
80106f20:	89 c8                	mov    %ecx,%eax
80106f22:	89 fa                	mov    %edi,%edx
80106f24:	ee                   	out    %al,(%dx)
80106f25:	89 f2                	mov    %esi,%edx
80106f27:	0f b6 44 0b 06       	movzbl 0x6(%ebx,%ecx,1),%eax
80106f2c:	ee                   	out    %al,(%dx)
80106f2d:	83 c1 01             	add    $0x1,%ecx
80106f30:	83 f9 19             	cmp    $0x19,%ecx
80106f33:	75 eb                	jne    80106f20 <write_regs+0x70>
80106f35:	31 c9                	xor    %ecx,%ecx
80106f37:	bf ce 03 00 00       	mov    $0x3ce,%edi
80106f3c:	be cf 03 00 00       	mov    $0x3cf,%esi
80106f41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106f48:	89 c8                	mov    %ecx,%eax
80106f4a:	89 fa                	mov    %edi,%edx
80106f4c:	ee                   	out    %al,(%dx)
80106f4d:	0f b6 44 0b 1f       	movzbl 0x1f(%ebx,%ecx,1),%eax
80106f52:	89 f2                	mov    %esi,%edx
80106f54:	ee                   	out    %al,(%dx)
...
80106f55:	83 c1 01             	add    $0x1,%ecx
80106f58:	83 f9 09             	cmp    $0x9,%ecx
80106f5b:	75 eb                	jne    80106f48 <write_regs+0x98>
80106f5d:	31 c9                	xor    %ecx,%ecx
static inline uchar
inb(ushort port)
{
  uchar data;
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106f5f:	bf da 03 00 00       	mov    $0x3da,%edi
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106f64:	be c0 03 00 00       	mov    $0x3c0,%esi
...
80106f77:	ee                   	out    %al,(%dx)
80106f78:	0f b6 44 0b 28       	movzbl 0x28(%ebx,%ecx,1),%eax
...
80106f7e:	83 c1 01             	add    $0x1,%ecx
80106f81:	83 f9 15             	cmp    $0x15,%ecx
80106f84:	75 ea                	jne    80106f70 <write_regs+0xc0>
static inline uchar
inb(ushort port)
{
  uchar data;
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106f86:	ba da 03 00 00       	mov    $0x3da,%edx
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106f8c:	ba c0 03 00 00       	mov    $0x3c0,%edx
80106f91:	b8 20 00 00 00       	mov    $0x20,%eax
...
80106fa1:	a1 40 b6 10 80       	mov    0x8010b640,%eax
	outb(VGA_GC_DATA, gc6);
}
...
80106fb3:	68 60 b4 10 80       	push   $0x8010b460
80106fb8:	e8 f3 fe ff ff       	call   80106eb0 <write_regs>
        graphics_mode = 1;
80106fbd:	c7 05 40 b6 10 80 01 	movl   $0x1,0x8010b640
80106fc4:	00 00 00 
	//TO-DO: Complete the function body
	return 0;
}
80106fc7:	31 c0                	xor    %eax,%eax
80106fc9:	c9                   	leave  
80106fca:	c3                   	ret    
80106fcb:	90                   	nop
80106fcc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80106fd0 <sys_exit_graphics>:
...
80106fd9:	68 a0 b4 10 80       	push   $0x8010b4a0
80106fde:	e8 cd fe ff ff       	call   80106eb0 <write_regs>
80106fe3:	b8 02 00 00 00       	mov    $0x2,%eax
80106fe8:	ba c4 03 00 00       	mov    $0x3c4,%edx
80106fed:	ee                   	out    %al,(%dx)
static inline uchar
inb(ushort port)
{
  uchar data;
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106fee:	be c5 03 00 00       	mov    $0x3c5,%esi
80106ff3:	89 f2                	mov    %esi,%edx
80106ff5:	ec                   	in     (%dx),%al
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106ff6:	bb 04 00 00 00       	mov    $0x4,%ebx
static inline uchar
inb(ushort port)
{
  uchar data;
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106ffb:	88 45 e7             	mov    %al,-0x19(%ebp)
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106ffe:	ba c4 03 00 00       	mov    $0x3c4,%edx
80107003:	89 d8                	mov    %ebx,%eax
80107005:	ee                   	out    %al,(%dx)
static inline uchar
inb(ushort port)
{
  uchar data;
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80107006:	89 f2                	mov    %esi,%edx
80107008:	ec                   	in     (%dx),%al
80107009:	88 45 e6             	mov    %al,-0x1a(%ebp)
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010700c:	83 c8 04             	or     $0x4,%eax
8010700f:	ee                   	out    %al,(%dx)
80107010:	bf ce 03 00 00       	mov    $0x3ce,%edi
80107015:	89 d8                	mov    %ebx,%eax
80107017:	89 fa                	mov    %edi,%edx
80107019:	ee                   	out    %al,(%dx)
static inline uchar
inb(ushort port)
{
  uchar data;
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010701a:	b9 cf 03 00 00       	mov    $0x3cf,%ecx
8010701f:	89 ca                	mov    %ecx,%edx
80107021:	ec                   	in     (%dx),%al
80107022:	88 45 e5             	mov    %al,-0x1b(%ebp)
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80107025:	89 fa                	mov    %edi,%edx
80107027:	b8 05 00 00 00       	mov    $0x5,%eax
...
inb(ushort port)
{
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010702d:	89 ca                	mov    %ecx,%edx
8010702f:	ec                   	in     (%dx),%al
80107030:	88 45 e4             	mov    %al,-0x1c(%ebp)
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80107033:	83 e0 ef             	and    $0xffffffef,%eax
80107036:	ee                   	out    %al,(%dx)
80107037:	b8 06 00 00 00       	mov    $0x6,%eax
...
inb(ushort port)
{
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010703f:	89 ca                	mov    %ecx,%edx
80107041:	ec                   	in     (%dx),%al
80107042:	88 45 e3             	mov    %al,-0x1d(%ebp)
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80107045:	83 e0 fd             	and    $0xfffffffd,%eax
80107048:	ee                   	out    %al,(%dx)
80107049:	89 d8                	mov    %ebx,%eax
8010704b:	89 fa                	mov    %edi,%edx
8010704d:	ee                   	out    %al,(%dx)
8010704e:	b8 02 00 00 00       	mov    $0x2,%eax
80107053:	89 ca                	mov    %ecx,%edx
80107055:	ee                   	out    %al,(%dx)
80107056:	ba c4 03 00 00       	mov    $0x3c4,%edx
8010705b:	ee                   	out    %al,(%dx)
8010705c:	89 d8                	mov    %ebx,%eax
8010705e:	89 f2                	mov    %esi,%edx
80107060:	ee                   	out    %al,(%dx)
80107061:	58                   	pop    %eax
80107062:	be 00 80 0b 80       	mov    $0x800b8000,%esi
80107067:	bb 60 a4 10 80       	mov    $0x8010a460,%ebx
...
80107073:	6a 10                	push   $0x10
80107075:	53                   	push   %ebx
		buf += font_height;
80107076:	83 c3 10             	add    $0x10,%ebx
	set_plane(2);
/* write font 0 */
	for(i = 0; i < 256; i++)
	{
		//vmemwr(16384u * 0 + i * 32, buf, font_height);
		memmove(P2V(0xb8000)+16384u * 0 + i * 32, buf, font_height);
80107079:	56                   	push   %esi
8010707a:	83 c6 20             	add    $0x20,%esi
8010707d:	e8 3e d4 ff ff       	call   801044c0 <memmove>
...
80107085:	81 fb 60 b4 10 80    	cmp    $0x8010b460,%ebx
8010708b:	75 e3                	jne    80107070 <sys_exit_graphics+0xa0>
8010708d:	be c4 03 00 00       	mov    $0x3c4,%esi
80107092:	b8 02 00 00 00       	mov    $0x2,%eax
80107097:	89 f2                	mov    %esi,%edx
80107099:	ee                   	out    %al,(%dx)
8010709a:	bb c5 03 00 00       	mov    $0x3c5,%ebx
8010709f:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
801070a3:	89 da                	mov    %ebx,%edx
801070a5:	ee                   	out    %al,(%dx)
801070a6:	b9 04 00 00 00       	mov    $0x4,%ecx
801070ab:	89 f2                	mov    %esi,%edx
801070ad:	89 c8                	mov    %ecx,%eax
801070af:	ee                   	out    %al,(%dx)
801070b0:	0f b6 45 e6          	movzbl -0x1a(%ebp),%eax
801070b4:	89 da                	mov    %ebx,%edx
801070b6:	ee                   	out    %al,(%dx)
801070b7:	bb ce 03 00 00       	mov    $0x3ce,%ebx
801070bc:	89 c8                	mov    %ecx,%eax
801070be:	89 da                	mov    %ebx,%edx
801070c0:	ee                   	out    %al,(%dx)
801070c1:	b9 cf 03 00 00       	mov    $0x3cf,%ecx
801070c6:	0f b6 45 e5          	movzbl -0x1b(%ebp),%eax
801070ca:	89 ca                	mov    %ecx,%edx
801070cc:	ee                   	out    %al,(%dx)
801070cd:	b8 05 00 00 00       	mov    $0x5,%eax
801070d2:	89 da                	mov    %ebx,%edx
801070d4:	ee                   	out    %al,(%dx)
801070d5:	0f b6 45 e4          	movzbl -0x1c(%ebp),%eax
801070d9:	89 ca                	mov    %ecx,%edx
801070db:	ee                   	out    %al,(%dx)
801070dc:	b8 06 00 00 00       	mov    $0x6,%eax
801070e1:	89 da                	mov    %ebx,%edx
801070e3:	ee                   	out    %al,(%dx)
801070e4:	0f b6 45 e3          	movzbl -0x1d(%ebp),%eax
801070e8:	89 ca                	mov    %ecx,%edx
801070ea:	ee                   	out    %al,(%dx)
sys_exit_graphics(void)
{
	...
	write_font(g_8x16_font, 16);
        graphics_mode = 0;
801070eb:	c7 05 40 b6 10 80 00 	movl   $0x0,0x8010b640
801070f2:	00 00 00 
	return 0;
}
801070f5:	8d 65 f4             	lea    -0xc(%ebp),%esp
801070f8:	31 c0                	xor    %eax,%eax
801070fa:	5b                   	pop    %ebx
801070fb:	5e                   	pop    %esi
801070fc:	5f                   	pop    %edi
801070fd:	5d                   	pop    %ebp
...
80107183:	83 ec 30             	sub    $0x30,%esp
	int x1, y1, x2, y2, color;
  if((argint(0, &x1) < 0) || (argint(1, &y1) < 0) || (argint(2, &x2) < 0) || (argint(3, &y2) < 0) || (argint(4, &color) < 0)) return -1; //missing args
80107186:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80107189:	50                   	push   %eax
8010718a:	6a 00                	push   $0x0
8010718c:	e8 8f d5 ff ff       	call   80104720 <argint>
80107191:	83 c4 10             	add    $0x10,%esp
80107194:	85 c0                	test   %eax,%eax
80107196:	78 68                	js     80107200 <sys_draw_line+0x80>
80107198:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010719b:	83 ec 08             	sub    $0x8,%esp
8010719e:	50                   	push   %eax
8010719f:	6a 01                	push   $0x1
801071a1:	e8 7a d5 ff ff       	call   80104720 <argint>
801071a6:	83 c4 10             	add    $0x10,%esp
801071a9:	85 c0                	test   %eax,%eax
801071ab:	78 53                	js     80107200 <sys_draw_line+0x80>
801071ad:	8d 45 ec             	lea    -0x14(%ebp),%eax
801071b0:	83 ec 08             	sub    $0x8,%esp
801071b3:	50                   	push   %eax
801071b4:	6a 02                	push   $0x2
801071b6:	e8 65 d5 ff ff       	call   80104720 <argint>
801071bb:	83 c4 10             	add    $0x10,%esp
801071be:	85 c0                	test   %eax,%eax
801071c0:	78 3e                	js     80107200 <sys_draw_line+0x80>
801071c2:	8d 45 f0             	lea    -0x10(%ebp),%eax
801071c5:	83 ec 08             	sub    $0x8,%esp
801071c8:	50                   	push   %eax
801071c9:	6a 03                	push   $0x3
801071cb:	e8 50 d5 ff ff       	call   80104720 <argint>
801071d0:	83 c4 10             	add    $0x10,%esp
801071d3:	85 c0                	test   %eax,%eax
801071d5:	78 29                	js     80107200 <sys_draw_line+0x80>
801071d7:	8d 45 f4             	lea    -0xc(%ebp),%eax
801071da:	83 ec 08             	sub    $0x8,%esp
801071dd:	50                   	push   %eax
801071de:	6a 04                	push   $0x4
801071e0:	e8 3b d5 ff ff       	call   80104720 <argint>
801071e5:	83 c4 10             	add    $0x10,%esp
801071e8:	85 c0                	test   %eax,%eax
801071ea:	78 14                	js     80107200 <sys_draw_line+0x80>
	return x1 + y1 + x2 + y2 + color;
801071ec:	8b 45 e8             	mov    -0x18(%ebp),%eax
801071ef:	03 45 e4             	add    -0x1c(%ebp),%eax
801071f2:	03 45 ec             	add    -0x14(%ebp),%eax
801071f5:	03 45 f0             	add    -0x10(%ebp),%eax
801071f8:	03 45 f4             	add    -0xc(%ebp),%eax
}
801071fb:	c9                   	leave  
801071fc:	c3                   	ret    
